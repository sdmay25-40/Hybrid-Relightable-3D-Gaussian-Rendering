...
{   
    ...
    private static AABB CreateAABBForGaussian(Gaussian3D gaussian, uint gaussianIdx)
    {
        ...
        */   
        ...
        Vector3 s1 = 3.0f * standardDeviationX * new Vector3(evd.EigenVectors.Column(0)[0], evd.EigenVectors.Column(0)[1], evd.EigenVectors.Column(0)[2]);
        Vector3 s2 = 3.0f * standardDeviationY * new Vector3(evd.EigenVectors.Column(1)[0], evd.EigenVectors.Column(1)[1], evd.EigenVectors.Column(1)[2]);
        Vector3 s3 = 3.0f * standardDeviationZ * new Vector3(evd.EigenVectors.Column(2)[0], evd.EigenVectors.Column(2)[1], evd.EigenVectors.Column(2)[2]);
    ...
    private static void BuildAABBsFromTree(MortonPayload[] mortonCodeTree, ref List<AABB> aabbs, Gaussian3D[] gaussians, int gaussianBufferIdx)
    {
        NativeArray<Gaussian3D> gaussiansNative = new NativeArray<Gaussian3D>(gaussians.Length, Allocator.Persistent);
        NativeArray<int> idxsTreeOrder = new NativeArray<int>(mortonCodeTree.Length, Allocator.Persistent); 
        NativeArray<AABB> aabbsNative = new NativeArray<AABB>(gaussians.Length, Allocator.Persistent);
    ...
    public static uint BuildBVHForGaussians(Gaussian3D[] gaussians, ref List<AABB> aabbs, int gaussianBufferIdx)
    {
